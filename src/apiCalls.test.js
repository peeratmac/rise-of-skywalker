...
describe('API CALLS', () => {
  ...
  const getAllMoviesDataResponse = [allMoviesData].sort(
    (a, b) => a.episode_id - b.episode_id
  );

  const mockResponse = { allMoviesData: allMoviesData };

  describe('GET ALL MOVIES DATA with Initial Fetch', () => {
    beforeEach(() => {
    ...
    it('should fetch upon mounting with the correct URL', () => {
      getAllMoviesData();
